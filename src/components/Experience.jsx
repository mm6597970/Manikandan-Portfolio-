            ...
            >
              ...
              <div className="glass-panel rounded-xl p-6 sm:p-8 hover:scale-[1.02] transition-all duration-300">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-4">
                  ...
                  <div className="flex items-center gap-1.5 text-xs sm:text-sm text-gray-600 font-mono self-start sm:self-center">
                ...
                <div className="border-t border-cyber-purple/10 pt-4">
                  <div className="flex items-center gap-2 mb-3 text-gray-900 font-mono text-xs font-semibold">
